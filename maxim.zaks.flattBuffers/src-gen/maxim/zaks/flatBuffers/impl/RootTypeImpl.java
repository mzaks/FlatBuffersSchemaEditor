 ...
 * </p>
 * <ul>
 *   <li>{@link maxim.zaks.flatBuffers.impl.RootTypeImpl#getType <em>Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RootTypeImpl extends MinimalEObjectImpl.Container implements RootType
{
  ...
  {
    return FlatBuffersPackage.Literals.ROOT_TYPE;
  }
    ...
    if (type != null && type.eIsProxy())
    {
      ...
      if (type != oldType)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, FlatBuffersPackage.ROOT_TYPE__TYPE, oldType, type));
      }
    }
    return type;
  }
  ...
  public void setType(Table newType)
  {
    ...
    type = newType;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, FlatBuffersPackage.ROOT_TYPE__TYPE, oldType, type));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case FlatBuffersPackage.ROOT_TYPE__TYPE:
